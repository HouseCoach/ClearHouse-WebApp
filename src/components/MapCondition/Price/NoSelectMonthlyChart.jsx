...
const PRICE_LABELS = [0, 30, 50, 70, 100, 150, 200];
  ...
  return (
    <div className={` select-none flex flex-col items-center`}>
      <div className="relative w-[300px]">
        ...
        {/* 라벨 */}
        <div className="mt-2 text-[10px] text-[#666666] w-[320px] flex justify-between absolute left-1">
